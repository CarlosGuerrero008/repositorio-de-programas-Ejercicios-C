namespace PagoPorMetroCubicoDeAgua
{
    public class PagoPorMetroCubicoDeAgua
    {
        public static void Main()
        {
            ...
            Console.WriteLine("Ingresa el valor de alto en m");
            alto_en_m = double.Parse(Console.ReadLine());
            Console.WriteLine("Ingresa el valor de ancho en m: ");
            ancho_en_m = double.Parse(Console.ReadLine());
            Console.WriteLine("Ingresa el valor de largo en m: ");
            largo_en_m = double.Parse(Console.ReadLine());
            Console.WriteLine("Ingresa el valor de precio por m3: ");
